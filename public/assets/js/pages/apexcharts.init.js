...
var options = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
  series: [{
  ...
  colors: barchartColors
}, "colors", ['#5fd0f3', '#495057', '#e83e8c', '#13d8aa', '#f34e4e', '#2b908f', '#f9a3a4', '#564ab1', '#f1734f', '#038edc']), "dataLabels", {
  enabled: true,
  textAnchor: 'start',
  style: {
    colors: ['#fff']
