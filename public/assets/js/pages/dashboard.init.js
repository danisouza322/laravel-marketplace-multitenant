...
var options = {
  series: [{
    data: [{
      x: 'Iphone',
      y: [new Date('2021-10-02').getTime(), new Date('2021-10-10').getTime()],
      fillColor: barchartColors[0]
    }, {
      x: 'Android',
      y: [new Date('2021-10-12').getTime(), new Date('2021-10-21').getTime()],
      fillColor: barchartColors[1]
    }, {
      x: 'Watch 8',
      y: [new Date('2021-10-06').getTime(), new Date('2021-10-16').getTime()],
      fillColor: barchartColors[0]
    }, {
      x: 'Books',
      y: [new Date('2021-10-12').getTime(), new Date('2021-10-22').getTime()],
      fillColor: barchartColors[1]
    }, {
      x: 'Speaker',
      y: [new Date('2021-10-05').getTime(), new Date('2021-10-16').getTime()],
      fillColor: barchartColors[0]
    }, {
      x: 'Cover',
      y: [new Date('2021-10-17').getTime(), new Date('2021-10-26').getTime()],
      fillColor: barchartColors[1]
    }]
  }],
  chart: {
