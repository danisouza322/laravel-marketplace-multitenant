...
var third_party_assets = {
    css_js: [{
        ...
        {
            "name": "imask",
            "assets": ["./node_modules/imask/dist/imask.min.js"]
        },
        ...
        {
            "name": "quill",
            "assets": ["./node_modules/quill/dist/quill.js",
        ...
        {
            "name": "rater-js",
            "assets": ["./node_modules/rater-js/index.js"]
        },
...
mix.sass('resources/scss/icons.scss', folder.dist_assets + "css").options({
    processCssUrls: false
}).minify(folder.dist_assets + "css/icons.css");
mix.sass('resources/scss/app.scss', folder.dist_assets + "css").options({
    processCssUrls: false
...
mix.combine('resources/js/pages/ecommerce-product-detail.init.js', folder.dist_assets + "js/pages/ecommerce-product-detail.init.js");
...
mix.combine('resources/js/pages/chartjs.js', folder.dist_assets + "js/pages/chartjs.js");
