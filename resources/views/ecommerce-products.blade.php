                        ...
                        <div class="collapse show" id="categories-collapse">
                            <div class="card p-2 border shadow-none">
                                <ul class="list-unstyled categories-list mb-0">
                                    <li><a href="#" class="text-body"><i class="mdi mdi-circle-medium me-1"></i>
                                            Formal Shoes</a></li>
                                    <li class="active"><a href="#" class="text-body"><i
                                                class="mdi mdi-circle-medium me-1"></i> Sports Shoes</a></li>
                                    <li><a href="#" class="text-body"><i class="mdi mdi-circle-medium me-1"></i>
                                            casual Shoes</a></li>
                                    <li><a href="#" class="text-body"><i class="mdi mdi-circle-medium me-1"></i>
                                            Sandals</a></li>
