                                ...
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge text-danger  bg-danger-subtle font-size-12">Cancel</span>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge text-success  bg-success-subtle font-size-12">Success</span>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <a class="text-muted dropdown-toggle font-size-20" role="button"
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge text-info bg-info-subtle font-size-12">Active</span>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <a class="text-muted dropdown-toggle font-size-20" role="button"
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge text-warning  bg-warning-subtle font-size-12">Pending</span>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <a class="text-muted dropdown-toggle font-size-20" role="button"
