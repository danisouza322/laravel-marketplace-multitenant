            ...
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="lineChart" class="chartjs-chart"
                        data-colors='["rgba(57, 128, 192, 0.2)", "#3980c0", "rgba(235, 239, 242, 0.2)", "#ebeff2"]'></canvas>
                </div>
            </div>
        </div> <!-- end col -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="bar" class="chartjs-chart"
                        data-colors='["rgba(51, 161, 134, 0.8)", "rgba(51, 161, 134, 0.9)"]'></canvas>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="polarArea" class="chartjs-chart" data-colors='["#fa6374", "#33a186", "#fc931d", "#3980c0"]'>
                    </canvas>
                </div>
            </div>
        </div> <!-- end col -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="radar" class="chartjs-chart"
                        data-colors='["rgba(42, 181, 125, 0.2)", "#33a186", "rgba(57, 128, 192, 0.2)", "#3980c0"]'></canvas>
                </div>
            </div>
        </div> <!-- end col -->
    </div>
@endsection
@section('script')
    <script src="{{ URL::asset('assets/libs/chart/chart.min.js') }}"></script>
