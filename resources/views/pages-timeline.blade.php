                                    ...
                                    <div class="event-list">
                                        <div class="item event-list">
                                            ...
                                            <div class="px-3">
                                                ...
                                                <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit
                                    ...
                                    <div class="event-list">
                                        <div class="item event-list">
                                            ...
                                            <div class="px-3">
                                                ...
                                                <p class="text-muted">Quis autem vel eum iure reprehenderit qui in ea
                                                    voluptate velit esse quam</p>
                                                <div>
                                                    <a href="#">View more <i class="mdi mdi-arrow-right"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="event-list">
                                        <div class="item event-list">
                                            ...
                                            <div class="px-3">
                                                ...
                                                <p class="text-muted">Itaque earum rerum hic tenetur a sapiente delectus
                                                    maiores alias consequatur aut</p>
                                                <div>
                                                    <a href="#">View more <i class="mdi mdi-arrow-right"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="event-list">
                                        <div class="item event-list">
                                            ...
                                            <div class="px-3">
                                                ...
                                                <p class="text-muted">Donec quam felis ultricies nec pellentesque eu pretium
                                                    sem consequat quis</p>
                                                <div>
                                                    <a href="#">View more <i class="mdi mdi-arrow-right"></i></a>
                                                </div>
                                            </div>
                    ...
                    <div class="">
                        <ul class="verti-timeline list-unstyled">
                            <li class="event-list">
                                ...
                                <p class="text-muted">Perspitis unde omnis it voluptatem accusantium doloremque laudantium,
                            ...
                            <li class="event-list">
                                ...
                                <p class="text-muted">Vivamus ultrices massa turna interdum eu. Pellentesque habitant morbi
                                    tristique eget justo sit amet est varius mollis et quis nisi. Suspendisse potenti.
                                    senectus et netus et malesuada fames ac turpis egestas.</p>
                            </li>
                            <li class="event-list">
                                <div class="event-date text-primar">16 May</div>
                                <h5 class="font-size-17">Timeline event Four</h5>
                                <p class="text-muted mb-0">Printing and typesetting industry. been the industry'scrambled
                            ...
                            <li class="event-list">
                                ...
                                <p class="text-muted">Excepturi, obcaecati, quisquam id
                                    ...
                                    Odit, itaque, deserunt corporis vero ipsum nisi repellat ... <a href="#">Read
                                        more</a></p>
                            </li>
                        </ul>
                    </div>
