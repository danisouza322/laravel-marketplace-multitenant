...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Novo Produto @endslot
    @endcomponent
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2 @error('categoria_id') is-invalid @enderror" id="categoria_id" name="categoria_id">
                                        ...
                                        @foreach($categorias as $id => $nome)
                                            <option value="{{ $id }}" {{ old('categoria_id') == $id ? 'selected' : '' }}>{{ $nome }}</option>
                                        @endforeach
                                    </select>
                                    @error('categoria_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control @error('preco') is-invalid @enderror" id="preco" name="preco" value="{{ old('preco') }}" required>
                                        @error('preco')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">R$</span>
                                        <input type="number" step="0.01" min="0" class="form-control @error('preco_promocional') is-invalid @enderror" id="preco_promocional" name="preco_promocional" value="{{ old('preco_promocional') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control @error('ordem') is-invalid @enderror" id="ordem" name="ordem" value="{{ old('ordem', 0) }}">
                                    @error('ordem')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch form-switch-lg mt-4">
                                        <input class="form-check-input" type="checkbox" id="destaque" name="destaque" {{ old('destaque') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch form-switch-lg mt-4">
                                        <input class="form-check-input" type="checkbox" id="ativo" name="ativo" {{ old('ativo', 1) ? 'checked' : '' }}>
